...
* Registro transaccional de transferencias (precio pagado, club comprador, club vendedor, jugador, fecha y temporada).
* Valor de mercado estimado del futbolista al momento exacto previo a la transferencia.
* Serie temporal histórica del Índice Armonizado de Precios de Consumo (HICP / Inflación Europea y de Reino Unido).
...
## 5. Preguntas a responder con los datos

1. ¿Cuál es la magnitud real del sobreprecio pagado por la Premier League (en millones de euros y porcentaje) en comparación con la tasación de mercado a lo largo de las últimas 15 temporadas?
2. ¿Cómo se compara la curva de crecimiento del gasto en fichajes frente a la curva de la inflación real europea (HICP) entre 2010 y 2026?
3. ¿Qué instituciones presentan los índices más altos de ineficiencia financiera (mayor sobreprecio sistemático) y qué clubes destacan por capturar infraprecio (compras por debajo del valor de mercado)?
4. ¿Se intensificó el sobreprecio a partir de hitos comerciales específicos, como la entrada del macro-contrato televisivo en la temporada 2016/17?
5. ¿Pagan los clubes de clase media un porcentaje de sobreprecio mayor que el *Big Six* al realizar compras de emergencia en ventanas de invierno?

---

## 6. Historia visual

### La narrativa y lo nuevo
La webstory planteará un recorrido interactivo en tres actos que desmontará el mito de que los precios suben "porque todo está más caro". A través de la confrontación visual de datos macroeconómicos vs. microeconómicos, el usuario descubrirá cómo se gestó la burbuja financiera del fútbol inglés y qué clubes han sido víctimas o artífices de esta distorsión.

### Elementos digitales y recursos interactivos planificados
* **Gráfico comparativo de doble eje temporal:** Una línea de base estable que represente la inflación acumulada HICP (2%–3% anual) contrastada con la curva exponencial del gasto en fichajes de la Premier League.
* **Diagrama de dispersión interactivo (*Scatter plot* de Sobreprecio vs. Infraprecio):** Plano cartesiano donde cada punto es un jugador ($X = \text{Valor de mercado}$, $Y = \text{Precio pagado}$). La línea diagonal $y=x$ marcará el precio justo; los puntos superiores reflejarán sobreprecio (en tonos rojos) y los inferiores infraprecio/gangas (en tonos azules), desplegando fichas técnicas al hacer hover/clic.
* **Matriz de eficiencia por clubes (Barras divergentes):** Gráfico interactivo que ordene a los clubes desde los más inflacionarios hasta los más eficientes, permitiendo filtrar por períodos históricos.
* **Referencias visuales:** Reportajes interactivos de datos de *The Pudding* (narrativa guiada por scroll), *FiveThirtyEight* (visualización estadística deportiva) y gráficos dinámicos de *The New York Times*.

---

## 7. Resultados esperados

* **Alcance mínimo:** Un informe interactivo estructurado con gráficos dinámicos en Datawrapper que documente la brecha entre el gasto real de la Premier League y la inflación HICP, junto con el cálculo de la mediana de sobreprecio anual en las 15 temporadas analizadas.
* **Alcance máximo:** Una webstory interactiva completa alojada en GitHub Pages bajo técnica de *scrollytelling*, que permita al lector interactuar con los 967 fichajes de la muestra, filtrar por club para conocer su balance de sobreprecio/infraprecio y explorar casos de estudio paradigmáticos de la economía del fútbol moderno.
