...
Este documento detalla los conjuntos de datos que sustentan la investigación sobre la evolución económica, la inflación y el sobreprecio en el mercado de fichajes de la Premier League entre las temporadas 2004/05 y 2025/26.
...
Al contrastar transfer_fee frente a market_value_in_eur, permite cuantificar de manera directa el sobreprecio monetario absoluto (
Sobreprecio
=
Fee
−
Market Value
) y la prima porcentual pagada por los clubes ingleses a lo largo de 15 temporadas.
